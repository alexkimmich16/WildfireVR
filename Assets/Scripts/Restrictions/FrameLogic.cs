...
namespace RestrictionSystem
{
    ...
    public class SideInfo
    {
        ...
        public SideInfo()
        {
            ...
            for (int i = 0; i < Enum.GetValues(typeof(Spell)).Length - 1; i++)
    ...
    public class FrameLogic : SerializedMonoBehaviour
    {
        ...
        public MotionInfo GetMotionInfo(Side side, Spell motion) { return PastMotionFrames[(int)side].Motions[(int)motion - 1]; }
        void Start()
        {
            //Initialize Frames
        ...
        public void InputRawMotionState(Side side, Spell Motion, bool State, float Time)
        {
        ...
        public bool Calculate(Side side, Spell Motion)
        {
            //*sequence matters*
